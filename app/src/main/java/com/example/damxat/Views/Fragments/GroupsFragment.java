...
public class GroupsFragment extends Fragment {
    ...
    public void showDialog(){
        ...
        btnSaveList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Here we have a reference to the firebase database instance
                // After getting the reference we create a new group instance
                // Then we save the group by the reference in firebase
    ...
    public void refreshRecycler(){
        ...
        // Here we are adding a listener to the reference so we know when it changes it's data
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                arrayGroups.clear();
                // Here we are going by every child that the group has and adding it to our list of groups
